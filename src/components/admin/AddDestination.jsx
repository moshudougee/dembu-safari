...
import { createDestination } from '@/lib/server/destinationActions'

const AddDestination = ({ counties, categories, popular }) => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const res = await createDestination(destinationData)
            if (res) {
           ...
           console.log(error)
           toast.error('Internal Server error, creating destination') 
        } finally {
            setIsLoading(false)
        }
    }
